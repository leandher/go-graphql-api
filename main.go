...
import (
	...
	"github.com/leandher/go-graphql-api/gql"
	"github.com/leandher/go-graphql-api/postgres"
	"github.com/leandher/go-graphql-api/server"
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "postgres", "q1w2e3r4", "go_graphql_db"),
	)
	if err != nil {
		log.Fatal(err)
	}
